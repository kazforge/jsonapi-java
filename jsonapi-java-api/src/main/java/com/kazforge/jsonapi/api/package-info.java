 ...
 * target.
 *
 * <p>The root {@link com.kazforge.jsonapi.api.JsonApi} exposes four facets: {@link
 * com.kazforge.jsonapi.api.JsonApiResources} (resources, create/update authoring), {@link
 * com.kazforge.jsonapi.api.JsonApiRelationships} (relationship-linkage documents), {@link
 * com.kazforge.jsonapi.api.JsonApiDocuments} (raw/general documents), and {@link
 * com.kazforge.jsonapi.api.JsonApiPatches} (presence-aware PATCH). Values {@link
 * com.kazforge.jsonapi.api.ResourceWriteOptions}, {@link
 * com.kazforge.jsonapi.api.ResourceDocument}, and {@link
