 ...
 * Jackson property name on the application type (used for application-property correspondence).
 * Configured Jackson performs the translation; there is deliberately no single ambiguous {@code
 * name} field.
 */
