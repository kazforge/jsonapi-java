 ...
 * framework integrations, currently housed in this historically named module.
 *
 ...
 * com.kazforge.jsonapi.jackson.internal} namespace is an unsupported implementation detail shipped
 * for adapter cooperation; its Java-public types are not supported API and must not appear in
