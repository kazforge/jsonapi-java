 ...
 * integrations. The nested {@code com.kazforge.jsonapi.jackson.internal..} namespace is an
 ...
 *
 * <ul>
 *   <li>{@code com.kazforge.jsonapi.jackson.document} — document contracts
 *   <li>{@code com.kazforge.jsonapi.jackson.mapping} — domain/mapping contracts
 *   <li>{@code com.kazforge.jsonapi.jackson.patch} — PATCH contracts
 *   <li>{@code com.kazforge.jsonapi.jackson.representation} — representation shaping
 *   <li>{@code com.kazforge.jsonapi.jackson.diagnostic} — diagnostics
 *   <li>{@code com.kazforge.jsonapi.jackson.api} — Level-1 application operation contract ({@code
 *       JsonApi} root plus resources/relationships/documents/patches facets)
 * </ul>
 *
 ...
 * com.kazforge.jsonapi.jackson.diagnostic.MappingLocation}. Producers address one resource object
 * with resource-relative pointers over JSON:API member names; absence is {@code null}, never {@code
 * ""} or {@code /}; segments are individually RFC 6901-escaped. See {@link
 * com.kazforge.jsonapi.jackson.diagnostic.JsonApiMappingException} for the full coordinate
 * contract.
 *
 ...
 * com.kazforge.jsonapi.jackson.patch.PatchChange} entries in {@code changes()} are present and
 ...
 * {@link com.kazforge.jsonapi.jackson.patch.PatchPresence}, whose {@link
 * com.kazforge.jsonapi.jackson.patch.PatchPresence.Present} with a {@code null} value is explicit
 * null, never omission. Recursive structured attributes use {@link
