 ...
 * validation context selects operation and endpoint semantics; the primary-data kind independently
 * selects whether primary objects and arrays decode as resources or identifiers. Readers do not
