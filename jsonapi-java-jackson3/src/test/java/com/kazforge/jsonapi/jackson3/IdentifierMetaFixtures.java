 ...
 * JavaType} preservation, configured naming, custom serializers, and custom linkage-mapper targets.
 * Shared wrapper/container/lid/additional-member carriers live in the Jackson API test fixtures.
 */
public final class IdentifierMetaFixtures {
  ...
  public static final class NullIdMetaSerializer extends ValueSerializer<NullIdMeta> {
    @Override
    public void serialize(NullIdMeta value, JsonGenerator generator, SerializationContext context) {
      generator.writeNull();
    }
  }
