...
import com.kazforge.jsonapi.fixtures.domainpatch.ArticleWithBoxList
...
import com.kazforge.jsonapi.fixtures.domainpatch.PatchPresenceTitleArticle
...
class PatchBindingSpec extends Specification {
  ...
  def "rejects patch #id with a mapping diagnostic"() {
    ...
    "patch-scalar-meta-target" | "identity-only" | com.kazforge.jsonapi.fixtures.domainpatch.WholeMetaTargetFixtures.ScalarMetaArticle.class | MappingDiagnostic.INVALID_META_TARGET | "/meta"
    "patch-uuid-meta-target" | "identity-only" | com.kazforge.jsonapi.fixtures.domainpatch.WholeMetaTargetFixtures.UuidMetaArticle.class | MappingDiagnostic.INVALID_META_TARGET | "/meta"
    "patch-instant-meta-target" | "identity-only" | com.kazforge.jsonapi.fixtures.domainpatch.WholeMetaTargetFixtures.InstantMetaArticle.class | MappingDiagnostic.INVALID_META_TARGET | "/meta"
    "patch-uri-meta-target" | "identity-only" | com.kazforge.jsonapi.fixtures.domainpatch.WholeMetaTargetFixtures.UriMetaArticle.class | MappingDiagnostic.INVALID_META_TARGET | "/meta"
  }
