...
/** Jackson 3 binding of the shared advanced relationship-linkage read characterization contract. */
class Jackson3AdvancedReadCharacterizationSpec extends AdvancedReadCharacterizationSpec {
