...
/** Jackson 3 binding of the shared attribute characterization contract. */
class Jackson3AttributesCharacterizationSpec extends AttributesCharacterizationSpec {
