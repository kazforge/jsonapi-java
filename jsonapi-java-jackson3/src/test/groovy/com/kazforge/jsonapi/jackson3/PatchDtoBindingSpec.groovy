...
import com.kazforge.jsonapi.fixtures.domainpatch.AddressWithOptionalCityPatch
import com.kazforge.jsonapi.fixtures.domainpatch.AddressWithTagsPatch
...
import com.kazforge.jsonapi.fixtures.domainpatch.ArticleWithAddressTagsPatch
...
import com.kazforge.jsonapi.fixtures.domainpatch.ArticleWithGeoPatch
...
import com.kazforge.jsonapi.fixtures.domainpatch.ArticleWithOptionalCityPatch
...
import com.kazforge.jsonapi.fixtures.domainpatch.ArticleWithRelationshipLinkagePatch
...
import com.kazforge.jsonapi.fixtures.domainpatch.ConventionalIdPatch
import com.kazforge.jsonapi.fixtures.domainpatch.DirectPresentPatch
import com.kazforge.jsonapi.fixtures.domainpatch.GeoPatch
import com.kazforge.jsonapi.fixtures.domainpatch.IntIdPatch
import com.kazforge.jsonapi.fixtures.domainpatch.MutableAddressPatch
import com.kazforge.jsonapi.fixtures.domainpatch.MutableArticleWithAddressPatch
import com.kazforge.jsonapi.fixtures.domainpatch.NonPatchPresencePatch
import com.kazforge.jsonapi.fixtures.domainpatch.OptionalPatch
import com.kazforge.jsonapi.fixtures.domainpatch.PresenceIdPatch
import com.kazforge.jsonapi.fixtures.domainpatch.RawPatchPresencePatch
import com.kazforge.jsonapi.fixtures.domainpatch.UnannotatedPatch
...
class PatchDtoBindingSpec extends Specification {
  ...
  def "binds typed patch dto #id into an explicit DTO"() {
    ...
    "patch-dto-object-meta-atomic" | "meta-source-only" | com.kazforge.jsonapi.fixtures.domainpatch.WholeMetaTargetFixtures.ObjectMetaPatch.class | new com.kazforge.jsonapi.fixtures.domainpatch.WholeMetaTargetFixtures.ObjectMetaPatch("1", PatchPresence.present([source: "cms"]))
  }
  ...
  def "rejects typed patch dto #id with a mapping diagnostic"() {
    ...
    "patch-dto-unknown-relationship-meta" | "author-meta-with-data" | com.kazforge.jsonapi.fixtures.domainpatch.WholeMetaTargetFixtures.NoRelMetaPatch.class | MappingDiagnostic.UNKNOWN_PATCH_MEMBER | "/relationships/author/meta"
    "patch-dto-scalar-meta-target" | "title-with-meta-source" | com.kazforge.jsonapi.fixtures.domainpatch.WholeMetaTargetFixtures.ScalarMetaPatch.class | MappingDiagnostic.INVALID_META_TARGET | "/meta"
    "patch-dto-nested-presence-meta-target" | "title-with-meta-source" | com.kazforge.jsonapi.fixtures.domainpatch.WholeMetaTargetFixtures.NestedPresenceMetaPatch.class | MappingDiagnostic.INVALID_META_TARGET | "/meta"
    "patch-dto-uuid-meta-target" | "identity-only" | com.kazforge.jsonapi.fixtures.domainpatch.WholeMetaTargetFixtures.UuidMetaPatch.class | MappingDiagnostic.INVALID_META_TARGET | "/meta"
  ...
  def "unknown relationship meta diagnostic names the relationship wire name"() {
    ...
    when:
    reader.readValue(json, com.kazforge.jsonapi.fixtures.domainpatch.WholeMetaTargetFixtures.NoRelMetaPatch)
