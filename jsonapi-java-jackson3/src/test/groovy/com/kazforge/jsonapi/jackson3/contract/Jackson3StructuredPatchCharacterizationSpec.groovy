...
/** Jackson 3 binding of the shared recursive structured PATCH characterization contract. */
class Jackson3StructuredPatchCharacterizationSpec extends StructuredPatchCharacterizationSpec {
