...
import com.kazforge.jsonapi.jackson3.StructuredRecursionFixtures.OuterWithNullEmptyCity
...
import com.kazforge.jsonapi.jackson3.StructuredRecursionFixtures.OuterWithTypedContact
import com.kazforge.jsonapi.fixtures.domainpatch.Address
import com.kazforge.jsonapi.fixtures.domainpatch.AddressPatch
import com.kazforge.jsonapi.fixtures.domainpatch.Dimensions
import com.kazforge.jsonapi.fixtures.domainpatch.MixedAddressPatch
 ...
 * / {@code @JsonApiAttribute} / {@code AttributeChange} in scope, proving that the engine is
 * location-neutral and outer-state-policy-free.
 */
