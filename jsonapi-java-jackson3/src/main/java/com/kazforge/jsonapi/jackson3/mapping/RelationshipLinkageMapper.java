 ...
 * occurrence of a to-many {@link com.kazforge.jsonapi.mapping.RelationshipLinkage} collection) and
 ...
 * com.kazforge.jsonapi.mapping.RelationshipLinkage#target()} cannot be null, and omitting the wire
 * identifier would drop a linkage entry. Wrapped to-many properties never reassociate a
