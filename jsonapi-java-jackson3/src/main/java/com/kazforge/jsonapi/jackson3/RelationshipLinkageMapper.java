 ...
 * com.kazforge.jsonapi.core.model.ResourceIdentifier} shapes. The binder invokes the mapper only
 * for {@link RelationshipData.SingleLinkage} (to-one properties, including each occurrence of a
 * to-many {@link com.kazforge.jsonapi.jackson.mapping.RelationshipLinkage} collection) and
