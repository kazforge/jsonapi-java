 ...
 * JsonApiJackson3#writer} and {@link JsonApiJackson3#reader} as the sole public codec paths;
 ...
 * com.kazforge.jsonapi.jackson.api.JsonApi} contract with strict homogeneous reads,
 ...
 * com.kazforge.jsonapi.jackson.patch.PatchPresence} state; those adapter-owned wire states are not
 ...
 * {@link com.kazforge.jsonapi.jackson.mapping.ResourceTypeRegistry}: an immutable, Jackson-neutral
 * mapping from wire {@code type} strings to {@link java.lang.reflect.Type} targets (build via
 * {@code ResourceTypeRegistry.builder().register("articles", Article.class)}); reader construction
 * converts each target through its configured mapper and rejects disagreement between the explicit
 * key and configured metadata. A {@link JsonApiDomainDocument} carries flat primary DTOs and
 ...
 * com.kazforge.jsonapi.core.model.ResourceIdentifier} values and error documents never bind.
 *
 ...
 * com.kazforge.jsonapi.jackson.patch.PatchCommand} without constructing a DTO or reading {@code
 ...
 * com.kazforge.jsonapi.jackson.patch.PatchPresence}.
 *
 ...
 * update commands are Jackson-major-neutral contracts in {@link com.kazforge.jsonapi.jackson}; this
 * package holds only Jackson 3-bound factories, readers, writers, binders, and their
 * implementation.
 */
@NullMarked
