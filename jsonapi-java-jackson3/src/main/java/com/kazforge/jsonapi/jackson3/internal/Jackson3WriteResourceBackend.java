...
/**
 * Jackson 3 bridge exposing only the native capabilities the shared basic resource writer cannot
 ...
 * shared writer.
 */
final class Jackson3WriteResourceBackend
