 ...
 * request inclusion, or carry fetch, cascade, repository, or ORM policy. Configured Jackson is the
 * sole authority for property discovery, visibility, mix-ins, creators, serializers/deserializers,
 * cardinality, value-shape, and the external JSON:API relationship member name
 * ({@code @JsonProperty}, naming strategies, and other Jackson property mechanics).
 *
