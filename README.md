...
| `jsonapi-java-jackson2/`       | Jackson 2 Level-1 application runtime, document codec, domain-to-resource mapping, flat resource-to-DTO binding, and presence-aware PATCH |
