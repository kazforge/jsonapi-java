...
| [`jsonapi-java-mapping`](jsonapi-java-mapping/README.md) | Available | Internal cross-artifact mapping implementation namespace; published but unsupported consumer API |
