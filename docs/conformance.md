...
| Create rules scoped to the primary resource                                                                     | supported    | `included` resources and relationship linkage are exempt from the primary relationship-data rule and gain no nested-create interpretation; full linkage still enforced; pre-existing id-optional identity leniency is unchanged document-wide |
