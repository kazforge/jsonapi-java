...
| `lid`-only linkage accepted only as a self-reference to the primary create resource                    | supported    | Matching `type` + `lid`; unrelated linkage and included resources require `id` (`RESOURCE_ID_REQUIRED`) |
