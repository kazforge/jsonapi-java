 ...
 * built-in {@link io.github.kazemek.jsonapi.core.model.ResourceIdentifier} shapes. The binder
 * invokes the mapper only for {@link RelationshipData.SingleLinkage} (to-one properties, including
 * each occurrence of a to-many {@link RelationshipLinkage} collection) and non-empty {@link
