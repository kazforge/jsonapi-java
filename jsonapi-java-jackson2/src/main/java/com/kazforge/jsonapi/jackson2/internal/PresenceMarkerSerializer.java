 ...
 * JSON-compatible wire values retain normal mapper serialization semantics. Only the derived PATCH
 * DTO binder mapper registers this serializer; the caller's mapper is never mutated.
 */
