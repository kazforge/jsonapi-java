...
/** Jackson 2 binding of the shared low-level PATCH command characterization contract. */
class Jackson2PatchCommandCharacterizationSpec extends PatchCommandCharacterizationSpec {
